...
const Hero = () => {
  return (
    <section className="relative min-h-[90vh] flex items-center bg-lensfit-bg overflow-hidden pt-16 px-4 sm:px-6 lg:px-8">
      ...
      <div className="absolute inset-0 z-10 bg-gradient-to-b from-transparent via-transparent to-lensfit-bg"></div>
      ...
      <div className="relative z-20 max-w-7xl mx-auto px-6 md:px-12 w-full pt-20 pb-16">
        <div className="text-left max-w-2xl">
          ...
          <span className="font-gordita block text-[11px] font-normal text-white tracking-lensfit-wide mb-4 uppercase">
            POWERED BY CECOP
          </span>
          
          {/* Título Principal - Gordita Bold */}
          <h1 className="font-gordita text-lensfit-h1 font-bold text-white tracking-lensfit-tight mb-8 leading-[55px]">
            Sua vitrine com a qualidade<br />dos líderes do mercado:<br />Lentes de contato e lentes<br />oftalmológicas Lensfit
          </h1>
          
          {/* Descrição - Gordita Regular/Medium */}
          <p className="font-gordita text-lensfit-p text-white mb-12 leading-[21px] max-w-xl font-normal antialiased">
          ...
          <button className="
            ...
            font-gordita font-medium text-lensfit-btn text-white
            border-none rounded-[24px]
            bg-gradient-to-r from-lensfit-red to-lensfit-red-light
